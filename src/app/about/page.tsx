...
export default function About() {
  return (
    <main className="flex flex-col items-center justify-between px-12 sm:px-24 pt-6 about">
      <h1 className="text-xl">About</h1>

      {/* <div className="about-image border-solid">
          <Image src="/media/images/logo-16-9.png" alt="L Meriel Art" width='690' height='388' style={{ objectFit: 'cover', minWidth: '200px' }} />
        </div> */}
