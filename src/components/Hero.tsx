...
export default function Hero({heading, message, buttonText, url="#"}:{heading:string, message:string, buttonText?:string, url?:string}) {
    return (
        <div className="flex flex-col items-center justify-center pt-24 sm:pt-6 mb-4 hero">

                <div >
                    <Image src="/media/images/logo-16-9.png" alt="L Meriel Art" width='690' height='388' style={{ objectFit: 'cover', minWidth: '300px'}} />
                </div>
